...
<head>
	...
	<title>Sign In | River Plate</title>
			...
			<div class="row vh-100">
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="card" style="padding-left: 20%; background-color: rgb(54, 52, 52);" >
							<div class="card-body" >
								<div class="mb-3">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="class="form-label">
                                            <label for="email" class="col-md-8 col-form-label text-md-right" style="background:red; ">{{ __('E-Mail Address') }}</label>
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <label for="password"class="col-md-8 col-form-label text-md-right" style="background:red; ">{{ __('Password') }}</label>
...
<main>
@endsection
<script src="?php echo url('/'); ?>/admin/js/app.js"></script>
