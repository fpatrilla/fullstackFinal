                    ...
                    <div class="row">
                        ...
                        <form action="{{ route('products.update',$product->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="actividad" value="{{ $product->actividad }}" class="form-control" placeholder="actividad">
                           </div>
                           <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                           ...
                           <br>  
                           <div class="col-xs-12 col-sm-12 col-md-12 text-center" styk>
